...
Uni Rostock, IEF, INT, Signal- \& Systemtheorie, \#24015, SS2020,
\today, CC BY 4.0

\noindent Prof. Dr.-Ing. Sascha Spors, Dr.-Ing. Frank Schultz

\noindent \textbf{Solving 2nd Order, Linear, Ordinary Differential Equation with
...
\subsubsection{Case I for Homogeneous Solution (Kriechfall, starke Dämpfung if $\sigma_0<0$)}
For
\begin{align}
...
\subsubsection{Exponential Function (i.e. Eigenfunctions of the ODE)}
The particular solution $y_p$ for the inhomogeneous ODE with
$x = \e^{s_x t}$
requires the Ansatz
\begin{align}
...
\subsubsection{Cosine / Sine Functions (i.e. Special Case of ODE's Eigenfunctions)}
...
%##############################################################################
\subsection{Solution for Task a) in Time Domain / Impulse Response}
We shall solve
\begin{align}
...
%##############################################################################
\subsection{Solution for Task b) in Time Domain / Step Response}
We shall solve
\begin{align}
...
%##############################################################################
\subsection{Another Way to Solve Task a) in Time Domain / Impulse Response}
%
...
%##############################################################################
\subsection{Frequency Response of the System}
%
...
the \textbf{Laplace transform}, i.e. \textbf{the transfer function} along the
$\im\omega$-axis
\begin{align}
H(\im\omega)
...
\end{align}
This constitutes the \textbf{Fourier transform} of the system and is known as
\textbf{frequency response} $H(\im\omega)$.
%
