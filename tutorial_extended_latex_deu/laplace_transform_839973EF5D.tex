...
\verb|laplace_transform_839973EF5D|
...
\begin{figure}[h!]
\centering
\includegraphics[width=0.75\textwidth]{../laplace_transform/step_response_parts_839973EF5D}
...
\begin{figure}[h!]
\centering
\includegraphics[width=0.75\textwidth]{../laplace_transform/impulse_step_response_839973EF5D}
...
\begin{figure}[h!]
\centering
\includegraphics[width=0.75\textwidth]{../laplace_transform/initial_conditions_response_parts_839973EF5D}
...
\begin{figure}[b!]
\centering
\includegraphics[width=0.75\textwidth]{../laplace_transform/response_full_839973EF5D}
...
\begin{figure}[h!]
\centering
\includegraphics[width=0.75\textwidth]{../laplace_transform/sine_excitation_response_839973EF5D}
...
we get
\begin{align}
%0 \cdot s^1 + 1 \cdot s^0=  A s - A s_{\infty,1}^* + B s - B s_{\infty,1}\\
...
%
The gain factor of the system $K$ is scaled by the inverse angular frequency, which
itself is encoded in $\Im\{s_{\infty,1}\}$.
%
The poles should be in the left $s$-plane, hence $\Re\{s_{\infty,1}\}<0$, such that
the exponential function is decaying.
%
...
\begin{figure}[h!]
\centering
\includegraphics[width=0.75\textwidth]{../laplace_transform/frequency_response_mag_phase_839973EF5D}
