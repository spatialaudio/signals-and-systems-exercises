...
\begin{align}
	...
	&=\begin{cases}
		...
		\frac{-\frac{1}{4}-\im\frac{13}{4\cdot\sqrt{3}}}{(z-(\frac{1}{4}+\im\frac{\sqrt{3}}{4}))^{|k|+1}}\cdot(-1)^{|k|}+\frac{-\frac{1}{4}+\im\frac{13}{4\cdot\sqrt{3}}}{(z-(\frac{1}{4}-\im\frac{\sqrt{3}}{4}))^{|k|}\cdot(-1)^{|k|}}, &k <0
	\end{cases}
\end{align}
\begin{align}
