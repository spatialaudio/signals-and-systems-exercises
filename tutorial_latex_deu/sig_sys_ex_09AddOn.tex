...
in zeit-diskrete Signale. Der Konvergenzbereich sei bei allen Aufgaben bis auf c) $|z|>1$ und bei Aufgabe c) $|z|>\frac{1}{2}$.
...
Es wird die Korrespondenztabelle der Vorlesung, die im StudIp zur Verfügung steht, genutzt. Diese deckt zwar nur allgemeine Fälle ab, ist damit jedoch übersichtlicher gehalten. In anderen Büchern (z.B. \cite[S. 1147-1149]{Bronstein} oder \cite[S. 237-238]{UlrichWeber} ) gibt es weit umfangreichere Korrespondenztabellen, diese können jedoch nicht in der Prüfung verwendet werden.
...
\subsection{Lösung mit Hilfe des Residuensatz}
...
Allgemein berechnet sich die inverse z-Transformation durch ein komplexes Kurvenintegral entlang einer geschlossenen Kurve $C$ im Konvergenzbereich (vgl. \cite[S. 192]{UlrichWeber2} ).
\begin{align}
...
Für die Berechnung der Residuen finden sich z.B. in \cite[S. 767-768]{Bronstein3}, \cite[S. 37-38]{UlrichWeber2} oder \cite[S. 137-138]{Fritzsche2019}.
%\subsubsection{Task a)}
\subsubsection{Aufgabe a)}
%We shall find the time-discret signal for
Wir wollen das zeit-diskrete Signal für
...
Es gelten (vgl. \cite[S. 81]{Bronstein2}):
\begin{align}
...
Die Exponentialfunktion lässt sich auch als Potenzreihe schreiben (vgl. \cite[S. 1077]{Bronstein}):
\begin{align}
