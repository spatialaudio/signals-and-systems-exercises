...
(elektrische Dauerlast, Wärme) oder gar nicht (z.B. über Luft) übertragen kann.
%
...
was ja eigentlich eher eine Definition, anstatt eine Eigenschaft ist (siehe UE1)
\begin{equation}
...
\end{axis}
\end{tikzpicture}
\caption{Ausgangspunkt: abfallende, vorauseilende Exp-Funktion.}
%\label{fig:}
\end{subfigure}
%
\begin{subfigure}{0.45\textwidth}
...
%
Essentiell bei der Faltung ist die Bedeutung der der Signaloperation $-\tau+t$
...
das gleiche, aber das sehen wir dann uU nicht mehr sofort.
...
\noindent\textbf{Hinweis 1}: Wir werden nach der Übung 3 in der Lage sein, $h(t)$ elegant herzuleiten.
...
Aus der ET wissen wir, dass dann $y(t) = U_q \e^{-\tau/T_\mathrm{RC}}$ gilt,
