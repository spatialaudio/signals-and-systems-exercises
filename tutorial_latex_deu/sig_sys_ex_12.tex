...
\end{Werkzeug}
\begin{Ansatz}
Wir setzen die DFT Synthese ($\tilde{x}, \tilde{X}$ als Hinweis, dass $N$-periodische Folgen)
%
\begin{equation}
...
weil ähnliche Umformungen immer wieder benötigt werden in SigSys.
%
\begin{align}
...
vgl.~\cite[(2.41)]{Moeser2011}, \cite[(2.142)]{Rabiner1975}
%
\begin{equation}
...
In Übung 7 auf Seite \pageref{pg:UE7:SpectrumInterpPlots} (17) waren es axialsymmetrische Signale, daher keine Phasenverschiebung.
%
