...
$H(s)$ ist keine echte gebrochen-rationale Funktion, weil Polynomgrad Zähler = Nenner. Erst eine Polynomdivision \, \polylongdiv[style=C, vars=s]{s}{s+w} \quad führt auf Parallelschaltung zweier Systeme
\begin{align}
