...
übersichtlicher aus, daher wählt man diese Konvention, also:
\begin{center}
\begin{tikzpicture}[thick, scale=0.7]
\newcommand{\filtDelay}{$z^{-1}$}
%\newcommand{\filtDelay}{$\ast_k \delta[k-1]$}
...
\end{tikzpicture}
\end{center}
Wahlweise könnte man auch mit dem Abtastintervall $T_s$ arbeiten und einen
...
\end{tikzpicture}
\end{center}
\textbf{e) Impulsantwort mittels Partialbruchzerlegung} wieder mit dem 'Trick',
