...
\draw[C3] (0,0) circle(1);
\node at (1, 1.25){$g = +1$};
\draw (1.75*0.86602540378,1.75*0.5) node[C2!75]{KB};
\draw[->] (-1.5,0)--(1.5,0) node[right]{$\Re\{z\}$};
\draw[->] (0,-1.5)--(0,1.5) node[above]{$\Im\{z\}$};
\draw (0.5, 0) node[C0]{\Huge $\times$};
\draw (0,0) node[C0]{\Huge $\circ$};
\draw (1+2*\tic,-2*\tic) node{$1$};
\draw (2.5,-1) node{$H(z) = 1 \cdot \frac{z}{z-\frac{1}{2}}$};
\end{tikzpicture}
\end{center}
%
...
\draw [->] (join0) -- (fbsplit0); \draw [->] (fbsplit0) -- (output);
