...
%
Wie üblich versuchen wir so viel wie möglich mit einfachen Rechnungen und
viel Anschauung zugänglich zu machen.
...
\end{align}
zu tun mit $\Sigma,\Omega\in\mathbb{R}$.
%
...
\textbf{Eigenfolgen von zeitdiskreten Systemen sind}, weclhe uns für SigSys speziell
interessiert.
%
...
6 & 1 & $1+\nicefrac{1}{2}+\nicefrac{1}{4}+\nicefrac{1}{8}+\nicefrac{1}{16}+\nicefrac{1}{32}$ & $1+\nicefrac{1}{2}+\nicefrac{1}{4}+\nicefrac{1}{8}+\nicefrac{1}{16}+\nicefrac{1}{32}+\nicefrac{1}{64}$ \\\hline
: & : & : & : \\\hline
$K \geq 0$ & 1 & $\sum_{m=0}^{K-1} \nicefrac{1}{2^m}$ & $\sum_{m=0}^K \nicefrac{1}{2^m}$ \\\hline
\end{tabular}
\end{center}
Auch hier können wir die Regelmäßigkeit schnell in eine Formel überführen, also für $k\geq 0$
\begin{align}
h_\epsilon[k] = \sum_{m=0}^k \frac{1}{2^m} = \sum_{m=0}^k \left(\frac{1}{2}\right)^m
\end{align}
...
\begin{align}
h_\epsilon[k] = \sum_{m=-\infty}^{k} h[m].
\end{align}
%
...
geometrische Reihe
\begin{align}
\sum_{m=0}^{\infty} a^m = \frac{1}{1-a}\text{ für } a<1
\end{align}
...
\begin{align}
h_\epsilon[k] = \sum_{m=0}^k \left(\frac{1}{2}\right)^m
\end{align}
...
Oben rechts: Impulsantwort, unten rechts: PN-Diagramm. So wie bei der Laplace
...
speziell Pegel (oben, links), Phase (Mitte, links), Gruppenlaufzeit
(unten, links) über die digitale Kreisfrequenz $\Omega$.
%
