...
ones and actually must haves to know about.
The so called Nyquist plot and the so called Nichols plot are common in
control system engineering.
We need to learn what to see in all these graphs.
\end{mdframed}
...
\begin{figure}
  ...
  The red line corresponds to the magnitude response along $-\omega...+\omega$.
...
\end{align}
%
Now we are ready to elaborate the magnitude frequency response prototypes for this
...
Thus, we can discuss the system characteristics by the \textbf{frequency response prototypes}
...
In the limiting cases, i.e. for frequencies much larger/smaller than around the pole/zero magnitude, the frequency response \textbf{can be approximated by straight-line equations}.
