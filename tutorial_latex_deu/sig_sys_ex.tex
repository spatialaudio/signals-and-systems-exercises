...
% \begin{Ziel}
% \end{Ziel}
% \textbf{Aufgabe} {\tiny 44EB4169E9}: Berechnen Sie...
% \begin{Werkzeug}
% \end{Werkzeug}
% \begin{Ansatz}
% \end{Ansatz}
...
% \begin{Ziel}
% \end{Ziel}
% \textbf{Aufgabe} {\tiny 590A7AFD51}: Berechnen Sie...
% \begin{Werkzeug}
% \end{Werkzeug}
% \begin{Ansatz}
% \end{Ansatz}
...
\end{equation}
Falls $x(t)$ eine Einheit hat, ist die Signalenergie in Einheit $\cdot$ Sekunde
gegeben.
\end{Loesung}
