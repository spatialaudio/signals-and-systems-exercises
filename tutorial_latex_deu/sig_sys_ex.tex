...
\small Vst.-Nr. 24015}
%
\author{Frank Schultz$^1$, Robert Hauser$^2$, Sascha Spors$^1$\\
\small $^1$Institut für Nachrichtentechnik (INT),\\
\small $^2$Institut für Angewandte Mikroelektronik und Datentechnik (IMD)\\
\small Fakultät für Informatik und Elektrotechnik (IEF)\\
\small Universität Rostock (UR)
}
%
\date{Sommersemester 2025, Version VI, kompiliert: \today}
%------------------------------------------------------------------------------
...
\input{sig_sys_ex_appendixC}
%\input{sig_sys_intended_schedule}
\renewcommand{\refname}{Literaturzitate und Buchempfehlungen}
\cite{*}
\clearpage
