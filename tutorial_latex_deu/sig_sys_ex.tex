...
%\input{sig_sys_ex_00}  % Einführung, FS, FT, Dirac, ODE2nd, h(t)

\setcounter{section}{1}
%\input{sig_sys_ex_01}  % Signal Ops, LTI, Conv
...
indiziert. Also: $-\delta(t-2)$ Gewicht $-1$ und um 2 zeitlich verzögert,
$+\delta(t+2)$ Gewicht $+1$ und um 2 zeitlich vorauseilend.
\end{Loesung}
